...
def parse_args():
    parser = argparse.ArgumentParser(description="Moirain DPO Inference")
    ...
    parser.add_argument("--inference.model_path", type=str, default="./ckpt/moirain_dpo/step_26626.pth")
...
def run():
    ...
    with torch.inference_mode():
        experiment = ExperimentMoirainDPOInference(conf)
