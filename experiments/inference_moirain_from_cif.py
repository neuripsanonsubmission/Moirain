...
class ExperimentMoirainInference(inference.ExperimentInference):
    ...
    def build_model(self):
        return model_moirain.MainModel(self.model_conf, self.tokenizer)
...
def parse_args():
    parser = argparse.ArgumentParser(description="Moirain Inference")

    # inference
    parser.add_argument("--inference.name", type=str, default="moirain")
    ...
    parser.add_argument("--inference.model_path", type=str, default="./ckpt/moirain/step_47876.pth")
...
def run():
    ...
    with torch.inference_mode():
        experiment = ExperimentMoirainInference(conf)
